...
5. Mô hình tổ chức chính quyền địa phương 2 cấp (Cấp Tỉnh và Cấp Xã): Chức năng của Sở Kế hoạch và Đầu tư (KH&ĐT) được sáp nhập vào Sở Tài chính (tiếp nhận nguyên trạng CSDL Đăng ký doanh nghiệp và CSDL Đầu tư; giữ nguyên mã định danh lịch sử, không sửa đổi hồi tố; lập Bảng ánh xạ mã ĐVHC trước - sau sắp xếp).
